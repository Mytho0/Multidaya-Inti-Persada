        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="remember"
                                class="rounded border-white/30 bg-white/20 text-white focus:ring-white/50">
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="w-full bg-white text-purple-600 font-bold py-3 px-4 rounded-xl hover:bg-white/90 transform hover:scale-105 transition-all duration-200 shadow-lg">
                ...
                <div class="mt-8 pt-6 border-t border-white/20">
                    <div class="bg-black/20 rounded-lg p-4">
                        ...
                        <div class="text-white/60 text-xs text-center space-y-1">
                            <p>Username: <span class="text-white font-mono bg-black/30 px-2 py-1 rounded">admin</span>
                            </p>
                            <p>Password: <span
                                    class="text-white font-mono bg-black/30 px-2 py-1 rounded">password123</span></p>
                        </div>
                    </div>
                </div>
            </div>
